...
let paths = {
	...
	images: 'src/images/**/*',
	buildFolder: 'build',
	buildPage: 'build/index.html',
	buildStylesFolder: 'build/styles',
	buildStyles: 'build/styles/**/*.css',
	buildJsFolder: 'build/js',
	buildJs: 'build/js/**/*.js',
	buildFontFolder: 'build/fonts',
	buildImagesFolder: 'build/images',
	buildBootstrap: 'build/js/bootstrap.min.js',
	buildJquery: 'build/js/jquery.min.js'
}
